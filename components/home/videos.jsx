...
import Goodie from '../../assets/vid1.jpg';
  ...
  return (
    <section className="relative text-white p-8 md:p-16 lg:p-32 overflow-hidden">
      ...
      <div className="relative z-20">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:justify-between md:w-[100%] md:mx-auto">
          {albums.map((album, index) => (
            <div key={index} className="flex flex-col items-center w-full md:w-[50%] md:flex-row md:items-start">
              <div className="w-full max-w-[300px] mb-4 md:w-[500px] md:mb-0 md:mr-4">
